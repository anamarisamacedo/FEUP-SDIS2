package communicationChannels.peer.server;
...
public class ServerChannel extends Channel implements Runnable {
     ...
     * @throws Exception
     */
    public ServerChannel(Peer p, String protocol, String hostAddress, int port) throws Exception {
        this.p = p;
        this.port = port;
                ...
                while (peerNetData.hasRemaining()) {
                    ...
                    switch (result.getStatus()) {
                        case OK:
                            ...
                            // StandardCharsets.UTF_8.decode(peerAppData).toString());
    ...
    protected void write(SocketChannel channel, SSLEngine engine, Send received) {
        byte[] message;
        try {
            message = PeerMessageAction.parseMessage(received, p).appendFinalInfo();
            myAppData.clear();
